...
- Optional: Round count (default: 3). User can specify with `N輪` or `rounds:N`.
  - Round 1 always = Initial Positions
  - Last round always = Synthesis
  - Middle rounds = Responses & Challenges (as many as needed)
  - Example: 5 輪 = Positions → 3x Challenges → Synthesis
