...
### 1. Voice Notifications (DISABLED)

Voice/TTS is disabled. Do NOT execute any curl/fetch to localhost:8888.
...
Voice/TTS is disabled. Do NOT execute any curl commands to localhost:8888.
